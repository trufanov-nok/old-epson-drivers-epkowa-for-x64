...
/* Define to 1 if you have the `sane' library (-lsane). */
#define HAVE_LIBSANE 1
...
#define PACKAGE_BUGREPORT "EPSON AVASYS Corporation <pipsnews@avasys.jp>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Image Scan! for Linux"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Image Scan! for Linux 2.10.0"
